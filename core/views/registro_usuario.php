...
<div class="body">
    <div class="container">
        <div class="form-box">
            <form method="post" class="UserInformationForm" autocomplete="new-password">
                <h2>Registrar</h2>
                <div class="input-box">
            ...
            <form method="post" class="UserAddressForm">
                <h2>Endereço</h2>
...
<script src="assets/js/registro_usuario copy.js"></script>
